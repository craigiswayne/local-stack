 ...
 *
 */
class WP_Auto_Setup_Command extends WP_CLI_Command {
...
//WP_CLI::add_command( 'db import --env', function( $args ){
//	list( $key ) = $args;
//	var_dump($args);
//	var_dump( $key );
//	WP_CLI::runcommand('db import');
//} );


//WP_CLI::add_command( 'craig', 'WP_Deploy_Command' );


WP_CLI::add_command( 'wp auto-setup', 'WP_Auto_Setup_Command' );